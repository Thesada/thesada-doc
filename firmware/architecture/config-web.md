...
```json
{
  "device":      { "name": "thesada-node", "friendly_name": "Thesada Node", "heartbeat_s": -1, "heartbeat_pin": -1, "charging_led": true },
  ...
  "mqtt":        { "broker": "...", "port": 8883, "user": "...", "password": "...",
                   ...
                   "ha_discovery": true, "reboot_after_fails": 30, "max_exhaust_reboots": 3 },
  ...
  "cellular":    { "apn": "APN", "sim_pin": "", "rf_settle_ms": 15000, "reg_timeout_ms": 180000, "activation_timeout_ms": 1800000 },
